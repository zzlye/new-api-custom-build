      ...
      {rows.map((row) => {
        ...
        return (
          <div
            ...
            className={cn(
              'appearance-glass-surface rounded-lg border px-3 py-2.5 transition-[border-color,box-shadow] duration-150 data-[state=selected]:border-primary/50 data-[state=selected]:ring-2 data-[state=selected]:ring-primary/20',
