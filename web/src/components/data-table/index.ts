...
export const DISABLED_ROW_MOBILE =
  '[--appearance-glass-surface-background:var(--table-disabled)] [--data-table-card-bg:var(--table-disabled)] data-[state=selected]:![--appearance-glass-surface-background:var(--table-disabled)] data-[state=selected]:![--data-table-card-bg:var(--table-disabled)] [background-color:var(--table-disabled)]'
