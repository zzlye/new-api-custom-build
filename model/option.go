...
func InitOptionMap() {
	...
	common.OptionMap["InviteTopUpCommissionRatio"] = strconv.FormatFloat(common.InviteTopUpCommissionRatio, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviteTopUpCommissionRatio":
		common.InviteTopUpCommissionRatio, _ = strconv.ParseFloat(value, 64)
